  ...
  if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
      ...
      verify_query($result_set);
        ...
        verify_query($result_set);
          // redirect to modify-user.php
          $url="modify-user.php?user_id=".$user['id'];
          header('Location: '.$url);
        } else {
...
<body>
  ...
  <div class="container">
    ...
    <form action="index-edit.php" method="post">
      
      <fieldset>
        <h1>Log in again to edit the user</h1>
        ...
        <p>
          <button type="submit" name="submit" id="submitBtn"  id="submitBtn" >Log In</button>
        </p>
         <p>
